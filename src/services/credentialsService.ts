...
export async function postCredential(credential: CreateCredentialData, userId: number) {
  ...
  const isCredentialExist = await credentialsRepository.getAllUserCredentialsByTitle(credential, userId);
...
export async function getAllCredentials(userId: number) {
  const allUserCredentials = await credentialsRepository.getAllUserCredentials(userId);
...
export async function getCredentialsById(userId: number, credentialId: number) {
  const credentialsById = await credentialsRepository.getCredentialById(userId, credentialId);
